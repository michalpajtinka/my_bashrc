...
# vim-like command line behaviour
# after pressing <c-x><c-e>, command will be edited in vim
# after pressing <c-x><c-f>, filename will complete inside vim
set -o vi
...
#
# set bell-style none
# would work in .inputrc only, thus bind is needed
...
alias gs='git status'
alias gsth='git stash show -v'
alias gcln='git clean'
alias gclnd='git clean -n'
alias gclnf='git clean -f'
alias gmtg='git mergetool -g'
